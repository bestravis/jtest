...
public class InviteCodeUtils {
    ...
    private static final char[] low=new char[]{'q', 'w', 'e', '8', 's', '2', 'd', 'z', 'x', '9', 'c', '7', 'p', '5', 'k', '3', 'm', 'j', 'u', 'f', 'r', '4', 'v', 'y', 't', 'n', '6', 'b', 'g', 'h'};
    ...
    public static void main(String[] args) {
    	String r=InviteCodeUtils.toSerialCode(1321);
    	long id=InviteCodeUtils.codeToId(r);
