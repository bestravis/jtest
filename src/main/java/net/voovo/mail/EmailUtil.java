...
public class EmailUtil implements Runnable {
    ...
    public void run() {
        ...
        // 3.发送一封激活邮件
        String from = "944983433@qq.com";// 发件人电子邮箱
        ...
        try {
            ...
            Session session = Session.getDefaultInstance(properties, new Authenticator() {
                public PasswordAuthentication getPasswordAuthentication() {
                    return new PasswordAuthentication("944983433@qq.com", "apmzcwjycpddbfjg"); // 发件人邮箱账号、授权码
                }
            });
    ...
    public static void main(String[] args) {
        String mailbox="software07@reading-pen.com";
        new Thread(new EmailUtil(mailbox, 666+"")).start();
    }
